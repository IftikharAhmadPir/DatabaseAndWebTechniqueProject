...
namespace DBWTechniqueData
{
    public class ProxyData
    {
        ...
        public void setFunctionalityTestingResults(string Test, int Result)
        {
            try
            {
                string query = "UPDATE functionalitytests SET Result= " + Result + " WHERE Test = " + Test + "";
